...
do
   az storage blob upload-batch --destination ${params.container_name}/content-plugins/$i --source content-plugins/$i --account-name $azure_account_name --account-key $azure_account_key
done
