...
describe('Shape plugin', function() {
    ...
    describe('should create all shapes', function() {
        it('should create rectangle and test circle configuration changes', function() {
            ...
            var fbObject = ContentEditorTestFramework.getFabricObject(rect.id, EkstepEditorAPI.getCanvas());
        ...
        it('should create circle and test circle configuration changes', function() {
            ...
            var fbObject = ContentEditorTestFramework.getFabricObject(circle.id, EkstepEditorAPI.getCanvas());
        ...
        it('should create rounded rectange and test configuration changes', function() {
            ...
            var fbObject = ContentEditorTestFramework.getFabricObject(roundedRect.id, EkstepEditorAPI.getCanvas());
        ...
        it('should create star shape and test configuration changes', function() {
            ...
            var fbObject = ContentEditorTestFramework.getFabricObject(star.id, EkstepEditorAPI.getCanvas());
        ...
        it('should create polygon shape and test configuration changes', function() {
            ...
            var fbObject = ContentEditorTestFramework.getFabricObject(polygon.id, EkstepEditorAPI.getCanvas());
        ...
        it('should create trapezium shape and test configuration changes', function() {
            ...
            var fbObject = ContentEditorTestFramework.getFabricObject(trapezium.id, EkstepEditorAPI.getCanvas());
        ...
        it('should create single arrow shape and test configuration changes', function() {
            ...
            var fbObject = ContentEditorTestFramework.getFabricObject(arrow.id, EkstepEditorAPI.getCanvas());
        ...
        it('should create double arrow shape and test configuration changes', function() {
            ...
            var fbObject = ContentEditorTestFramework.getFabricObject(doubleArrow.id, EkstepEditorAPI.getCanvas());
