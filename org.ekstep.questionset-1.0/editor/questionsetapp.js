...
angular.module('questionsetapp', [])
    .controller('questionsetcontroller', ['$scope', '$injector', 'instance', function($scope, $injector, instance) {
        ...
        if(ecEditor._.isUndefined(instance.questions.config)){
            ...
            ctrl.cart = { "items": instance.questions.data};
        ...
        ctrl.cart = {
            "items": (ecEditor._.isUndefined(instance.questions)) ? [] : instance.questions,
