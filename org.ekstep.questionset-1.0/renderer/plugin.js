...
Plugin.extend({
  ...
  initPlugin: function(data) {
    ...
    //Register for Hook mechanism
    EkstepRendererAPI.dispatchEvent('renderer:navigator:register',instance);
  ...
  renderNextQuestion: function() {
    ...
    if (nextQ) {
      ...
      //EkstepRendererAPI.dispatchEvent('renderer:navigator:deregister',instance);
      this.saveQuestionSetState();
