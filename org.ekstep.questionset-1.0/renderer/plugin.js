...
IteratorPlugin.extend({ // eslint-disable-line no-undef
  ...
  loadModules: function (question, callback) {
    ...
    this.loadController(controllerPath, function () {
      instance.loadTemplate(templatePath, instance._constants.qsElement, instance._currentQuestion, function () {
  ...
  loadTemplate: function (path, toElement, questionObj, callback) {
    setTimeout(function () {
