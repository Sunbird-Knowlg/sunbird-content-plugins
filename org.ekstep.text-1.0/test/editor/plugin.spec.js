...
describe("Text plugin", function() {
    ...
    it("should create plain text", function() {
        ...
        ContentEditorTestFramework.validateObject(text1.toECML(), {
            'x': 10, 'y': 20, 'minWidth': 20, 'w': 35, 'maxWidth': 500, 'fill': '#000000', 'fontStyle': 'normal', 'fontWeight': 'normal', 'h': 6.14, 'rotate': 0, 'textType': 'text', 'z-index': 0, 'font': 'NotoSans', 'fontsize': 58.67, 'weight': 'bold', 'id': text1.id, 'config.__cdata': '{"opacity":100,"strokeWidth":1,"stroke":"rgba(255, 255, 255, 0)","autoplay":false,"visible":true,"text":"","color":"#000000","fontfamily":"NotoSans","fontsize":22,"fontweight":true,"fontstyle":false,"align":"left"}'
        });
    ...
    it("should crate wordinfo text", function() {
        ...
        ContentEditorTestFramework.validateObject(wordinfo_text.toECML(),{ 
            "x": 10, "y": 20, "minWidth": 20,"w": 35, "maxWidth": 500, "fill": '#000000', "fontStyle": 'normal', "fontWeight": 'normal', "textType": 'wordinfo', "h": 5.02, "rotate": 0, "z-index": 1, "font": 'NotoSans', "fontsize": 48, "weight": '', "config.__cdata": '{"opacity":100,"strokeWidth":1,"stroke":"rgba(255, 255, 255, 0)","autoplay":false,"visible":true,"text":"","color":"#000000","fontfamily":"NotoSans","fontsize":18,"fontweight":false,"fontstyle":false,"align":"center","wordfontcolor":"#CC1234","wordhighlightcolor":"#CC1235","wordunderlinecolor":"#CC1236"}' 
        });
    });
