'use strict';
var fileUploader;
angular.module('org.ekstep.uploadcontent-1.3', []).controller('uploadController', ['$scope', '$injector', 'instance', function($scope, $injector, instance) {
    ...
    $scope.loaderIcon = ecEditor.resolvePluginResource("org.ekstep.uploadcontent", "1.3", "editor/loader.gif");
