'use strict';
var fileUploader;
angular.module('org.ekstep.uploadcontent-1.2', []).controller('uploadController', ['$scope', '$injector', 'instance', function($scope, $injector, instance) {
    ...
    $scope.loaderIcon = ecEditor.resolvePluginResource("org.ekstep.uploadcontent", "1.2", "editor/loader.gif");
            ...
            var data = {
                request: {
                    content: {
                        ...
                        "createdFor": _.keys(ecEditor.getContext('user').organisation),
                        "contentType": "Resource",
                        "resourceType": "Learn",
                        "creator": ecEditor.getContext('user').name,
                        "framework": ecEditor.getContext('framework'),
                        "organisation":_.values(ecEditor.getContext('user').organisation)
