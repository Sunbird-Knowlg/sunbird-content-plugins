    ...
    $scope.deleteNode = function(node, event) {
        if (!node.data.root) {
            ecEditor.getService('popup').open({
                template: '<div class="sb-modal sb-error"><div class="ui modal normal active" id="deletePopup"><div class="sb-modal-header"><label>Are you sure you want to delete this content?</label><i class="close icon" ng-click="closeThisDialog()"></i></div><div class="sb-modal-content"><p>All content within this folder will also be deleted from this textbook.</p></div><div class="sb-modal-actions"><button class="sb-btn sb-btn-normal sb-btn-error" ng-click="confirm()">Yes, Delete</button></div></div></div>',
                // <div class="ui mini modal active" id="deletePopup"> <div class="content"> <div class="ui grid"> <div class="ten wide column"> <span class="custom-modal-heading">Are you sure you want to delete this content?</span> </div><div class="two wide column"> <i class="close large icon four wide column right-float pointer" ng-click="closeThisDialog()"></i></div></div><p class="custom-modal-content">All content within this folder will also be deleted from this textbook.</p><button class="ui red button" ng-click="confirm()">YES, DELETE</button> </div></div>
