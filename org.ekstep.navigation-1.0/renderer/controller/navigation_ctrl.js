...
angular.module('genie-canvas').directive('customNextNavigation', function ($rootScope, $timeout) {
  return {
    restrict: 'E',
    template: '<div><a class="nav-icon nav-next" tabindex="-1" ng-show="showCustomNext !== state_off" href="javascript:void(0);"><img ng-src="{{customNextIcon}}" tabindex="0" ng-keydown="$event.keyCode === 13 && navigate(\'next\')" ng-click="navigate(\'next\')"></a></div>',
    link: function (scope) {
  ...
  return {
    restrict: 'E',
    template: '<div><a class="nav-icon nav-previous" tabindex="-1" ng-show="showCustomPrevious !== state_off" ng-class="{\'nav-disable\': showCustomPrevious == state_disable}" href="javascript:void(0);"><img ng-src="{{customePreviousIcon}}" tabindex="0" ng-keydown="$event.keyCode === 13 && navigate(\'previous\')" ng-click="navigate(\'previous\')"></a></div>',
    link: function (scope) {
