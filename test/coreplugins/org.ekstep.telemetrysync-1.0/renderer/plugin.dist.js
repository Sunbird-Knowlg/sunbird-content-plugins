...
org.ekstep.pluginframework.pluginManager.registerPlugin({"id":"org.ekstep.telemetrysync","ver":"1.0","shortId":"org.ekstep.telemetrysync","author":"Krushanu","description":"","publishedDate":"","renderer":{"main":"renderer/plugin.js","dependencies":[{"type":"js","src":"renderer/libs/detectClient.js"},{"type":"js","src":"renderer/libs/md5.js"}]}},Plugin.extend({_type:"telemetry",_isContainer:!1,_render:!0,_teleData:[],_maxTeleInstance:10,_requiredFields:{},initPlugin:function(e){console.log("Telemetry plugin init done !!!")},initialize:function(){EkstepRendererAPI.addEventListener("telemetryPlugin:intialize",this.initializeTelemetryPlugin,this)},initializeTelemetryPlugin:function(){if("undefined"==typeof cordova){this.listenTelementryEvent();var e=detectClient();this._requiredFields={};var t=EkstepRendererAPI.getGlobalConfig();this._requiredFields.uid=t.context.uid||t.uid,this._requiredFields.sid=t.context.sid||CryptoJS.MD5(Math.random().toString()).toString(),this._requiredFields.did=t.context.did||CryptoJS.MD5(JSON.stringify(e)).toString()}},listenTelementryEvent:function(){var t=this;EventBus.addEventListener("telemetryEvent",function(e){e=JSON.parse(e.target),3<=parseInt(e.ver)&&(e=t.appendRequiredFields(e),t.addToQueue(e))})},appendRequiredFields:function(e){return e.actor.id=e.actor.id||this._requiredFields.uid,e.context.did=e.context.did||this._requiredFields.did,e.context.sid=e.context.sid||this._requiredFields.sid,e},sendTelemetry:function(e){var t=(new Date).getTime(),i={id:"ekstep.telemetry",ver:TelemetryService._version,ets:t,events:e},n=EkstepRendererAPI.getGlobalConfig(),r={};_.isUndefined(n.context.authToken)||(r.Authorization="Bearer "+n.context.authToken),org.ekstep.service.renderer.sendTelemetry(i,r).then(function(e){console.log("Telemetry API success",e)})},addToQueue:function(e){if(this._teleData.push(e),"END"==e.eid.toUpperCase()||this._teleData.length>=this._maxTeleInstance){var t=_.clone(this._teleData);this._teleData=[],this.sendTelemetry(t)}}}))