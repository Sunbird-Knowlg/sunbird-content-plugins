...
org.ekstep.pluginframework.pluginManager.registerPlugin({"id":"org.ekstep.assessmentbrowser","ver":"1.0","shortId":"assessmentbrowser","author":"Santhosh Vasabhaktula","title":"AssessmentBrowser Plugin","description":"","publishedDate":"","editor":{"main":"editor/plugin.js","dependencies":[{"type":"plugin","plugin":"org.ekstep.conceptselector","ver":"1.1"},{"type":"js","src":"editor/assessmentbrowser_util.js"},{"type":"js","src":"editor/libs/xml2json.js"},{"type":"template","src":"./assessmentbrowser.html","bundle":true},{"type":"js","src":"./assessmentbrowserapp.js","bundle":true}]}},org.ekstep.contenteditor.basePlugin.extend({type:"assessmentbrowser",previewURL:(ecEditor.getConfig("previewURL")||"/content/preview/preview.html")+"?webview=true",callback:function(){},initialize:function(){var e=this;ecEditor.addEventListener(this.manifest.id+":show",this.showAssessmentBrowser,this),setTimeout(function(){ecEditor.resolvePluginResource(e.manifest.id,e.manifest.ver,"editor/assessmentbrowser.html"),ecEditor.resolvePluginResource(e.manifest.id,e.manifest.ver,"editor/assessmentbrowserapp.js");ecEditor.getService("popup").loadNgModules(require("./assessmentbrowser.html"),require("./assessmentbrowserapp.js"),!0)},1e3)},showAssessmentBrowser:function(e,s){var t=this;this.callback=s.callback,this.data=ecEditor._.isUndefined(s.data)?"":s.data,ecEditor.getService("popup").open({template:"assessmentbrowser",controller:"assessmentbrowsercontroller",controllerAs:"$ctrl",resolve:{instance:function(){return t}},width:900,showClose:!1,className:"ngdialog-theme-plain"})}}))