Plugin.extend({
    ...
    initPlugin: function(data) {
        ...
        if (value && _.isFinite(this._index) && this._index > -1) {
            ...
            } else if (this._parent._type.toLowerCase() == 'cmtf') {
    ...
    renderMTFOption: function(value) {
        ...
        if (enableDrag) {
            ...
            asset.on("mousedown", function(evt) {
                ...
                //audiManager.getEvenManager().processAppTelemetry({}, 'DRAG', instance, data);
            });
            ...
            asset.on("pressup", function(evt) {
                ...
                if (!snapSuccess) {
                    ...
                    instance.handleCommand("hide","submit_disabled");
                    instance.handleCommand("show","submit_enabled");
                }
                ...
                // audiManager.getEvenManager().processAppTelemetry({}, 'DROP', instance, data);
                Renderer.update = true;
            });
        }
    ...
    handleCommand: function(cmd,ast){
        var a={};
            a.type= "command";
            a.command= cmd;
            a.asset= ast;
