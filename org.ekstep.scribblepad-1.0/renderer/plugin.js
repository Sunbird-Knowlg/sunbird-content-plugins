Plugin.extend({
    ...
    initPlugin: function(data) { 
        ...
        var children = {
            "scribble": data,
            "image": { x: 100 - eraserW, y: 0, w: eraserW, h: eraserH, 'z-index': 1, asset: "org.ekstep.scribblepad.eraser", event: { type: "click", action: { asset: this._data.id, command: "erase", type: "command" } }}
        }
