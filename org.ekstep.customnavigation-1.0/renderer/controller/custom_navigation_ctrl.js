...
app.controllerProvider.register("CustomNavigationCtrl", function($scope, $rootScope, $compile, $stateParams, $timeout) {
  ...
  $scope.init = function() {
    ...
    $scope.pluginInstance = EkstepRendererAPI.getPluginObjs("org.ekstep.customnavigation");
  ...
  $scope.navigate = function(navType) {
    ...
    if (!$rootScope.content) {
      ...
      TelemetryService.interact("TOUCH", navType, null, {
        currentStageId: EkstepRendererAPI.getCurrentStageId()
      });
      if (navType === "next") {
        /**
...
app.compileProvider.directive('customNextNavigation', function($rootScope) {
  return {
    ...
    link: function(scope) {
      scope.customNextIcon = EkstepRendererAPI.resolvePluginResource("org.ekstep.customnavigation", "1.0", "renderer/assets/next.png");
...
app.compileProvider.directive('customPreviousNavigation', function($rootScope) {
  return {
    ...
    link: function(scope) {
      ...
      scope.customePreviousIcon = EkstepRendererAPI.resolvePluginResource("org.ekstep.customnavigation", "1.0", "renderer/assets/previous.png");
